...
// /*----- event listeners -----*/
// p1 buttons
// document.getElementById("stay1").addEventListener("click");
...
// document.getElementById("ins1").addEventListener("click");
...
function dealerPlay() {
  ...
  let dealerTotal = dealerHand.value.reduce((a, b) => a + b, 0);
